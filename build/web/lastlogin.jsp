  ...
  background: transparent;">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="testimonials.html">Crime News</a></li>
	  ...
	  <div class="sidebar_container">       
		...
		<div class="sidebar">
          <div class="sidebar_item">
            <h2>Crime News</h2>
            <h3>June 2014</h3>
            <p><U>NEWS CONTAINS THE POLICE STATION ID AND NEWS</U></p>         
		  </div><!--close sidebar_item--> 
        </div><!--close sidebar-->
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1>Welcome To City Without Crime Website</h1>
                  ...
                  <div  align="left"><img src="res/emergency.png" width="95" height="32" alt="" /></div>   
